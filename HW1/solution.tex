...
Part 1: MEME Implementation: Write a program, learn\_motif.py, that takes as input a set of DNA
  ...
  \begin{algorithm}[]
        \begin{algorithmic}[1]
            \Function{OOPS\_exhausive}{$input\_seqs, W, \pi_{init}$}
            	\State{} $seq\_to\_pwm\_hash \gets \Call{init\_seq\_to\_pwm}{W, \pi_{init}}$
                \If{$start \geq end$}
                    \State{} \Return{}
                \EndIf{}
